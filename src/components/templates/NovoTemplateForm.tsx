...
import { useCreateTemplate, CreateTemplateData } from "@/hooks/use-templates";
...
interface NovoTemplateFormProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function NovoTemplateForm({ open, onOpenChange }: NovoTemplateFormProps) {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ex: Petição Inicial Trabalhista" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
