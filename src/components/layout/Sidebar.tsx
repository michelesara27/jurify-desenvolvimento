            ...
            <Link key={item.href} to={item.href}>
              <Button
                ...
                className={cn(
                  ...
                  item.variant === "primary" && "bg-primary hover:bg-primary-hover text-primary-foreground",
                  isActive && item.variant !== "primary" && "bg-sidebar-accent text-sidebar-accent-foreground",
                  !isActive && item.variant !== "primary" && "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
                )}
              >
