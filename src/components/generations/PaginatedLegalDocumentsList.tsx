...
import { usePaginatedLegalDocuments, LegalDocument } from "@/hooks/use-paginated-legal-documents";
...
export function PaginatedLegalDocumentsList({
  ...
  const { documents, totalCount, totalPages, currentPage: page, hasNextPage, hasPreviousPage } = paginationData;
            ...
            <>
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm text-muted-foreground">
                  Página {page} de {totalPages} ({totalCount} {totalCount === 1 ? "documento" : "documentos"})
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm">{selectedDocument.title || "Sem título"}</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-1 text-sm">
                    ...
                    {format(new Date(selectedDocument.created_at), "dd/MM/yyyy 'às' HH:mm", {
                      locale: ptBR,
                    })}
                  </div>
                </div>
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-sm">
                          ...
                          {selectedDocument.client.email && (
                            <p className="text-muted-foreground">{selectedDocument.client.email}</p>
                          )}
                        </div>
                      </div>
                    )}
                    ...
                    {selectedDocument.case && (
                      <div className="space-y-2">
                        <h4 className="font-medium text-sm text-muted-foreground">CASO</h4>
                        <div className="text-sm">
                          <p className="font-medium">{selectedDocument.case.title}</p>
              ...
              {selectedDocument.content && (
                <>
                  <Separator />
                  <div className="space-y-2">
                    <h4 className="font-medium text-sm text-muted-foreground">CONTEÚDO COMPLETO</h4>
